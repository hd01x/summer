def _build_prompt(aspect_name, aspect_description, step1_guidance, step2_guidance, abstract):
    """Build a standardized prompt for a given medical aspect."""
    return f"""# Instruction:
You are given a medical abstract formatted as a list of indexed sentences.
Your task is to identify and summarize the information about {aspect_description} by performing the following steps:
...
Step 3 - Generate a summary:
    - Based solely on the identified sentences and extracted phrases, write ONE concise sentence summarizing {aspect_description}.
    - The summary should incorporate the extracted contributory phrases as much as possible.
...
def prompt_intrinsic(aspect, abstract):
